...
describe('Register type exercise controller (e2e)', () => {
  ...
  it('should not be able register type of exercise with out submit name', async () => {
    await supertest(app)
      .post('/users')
      .field('firstName', 'John')
      .field('lastName', 'Doe')
  ...
  it('should not be able register type of exercise with duplicate name', async () => {
    await supertest(app)
      .post('/users')
      .field('firstName', 'John')
      .field('lastName', 'Doe')
  ...
  it('should not be able register type of exercise with user role equal CLIENT', async () => {
    await supertest(app)
      .post('/users')
      .field('firstName', 'John')
      .field('lastName', 'Doe')
